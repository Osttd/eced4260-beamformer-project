...
add wave -noupdate -format Analog-Step -height 74 -max 499.99999999999994 -min -500.0 /FIR_Filter_tb/data_in
add wave -noupdate /FIR_Filter_tb/start
add wave -noupdate -format Analog-Step -height 74 -max 600000.0 -min -600000.0 /FIR_Filter_tb/data_out
add wave -noupdate /FIR_Filter_tb/x
add wave -noupdate /FIR_Filter_tb/y
