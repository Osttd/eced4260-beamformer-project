...
% ================================================================================
% Generated on: 11/27/2023 15:06:29
...
for j = 1:sx
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = BP_Filt_mlab(single_channel_data{i}, single_channel_bank{i});
  ...
  for j = 1: limit;
    ...
    file_name = ['BP_Filt_model_output'];
