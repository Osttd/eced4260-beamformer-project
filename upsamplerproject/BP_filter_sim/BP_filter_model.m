...
% ================================================================================
% Generated on: 11/20/2023 22:16:09
...
for j = 1:sx
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = BP_filter_mlab(single_channel_data{i}, single_channel_bank{i});
  ...
  for j = 1: limit;
    ...
    file_name = ['BP_filter_model_output'];
