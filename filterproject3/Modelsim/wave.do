...
add wave -noupdate -label filter_ram_out -radix decimal /FIR_Filter_tb/filter_ram_out
...
WaveRestoreCursors {{Cursor 1} {1150241 ps} 0}
...
update
WaveRestoreZoom {1142428 ps} {1183140 ps}
